...
coverage:
	...
	docker run -w /app -v ${ROOT}:/app ${GOLANG_DOCKER_IMAGE} /bin/bash -c "curl -L https://codeclimate.com/downloads/test-reporter/test-reporter-latest-linux-amd64 > ./cc-test-reporter"
